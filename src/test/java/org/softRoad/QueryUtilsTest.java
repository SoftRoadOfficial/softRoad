...
public class QueryUtilsTest {
    ...
    public void getConditionHqlQueryTest(){
        ...
        HqlQuery sqlResult1 = QueryUtils.getConditionHqlQuery(test1, null);
        Assertions.assertEquals(" .A = :A_0", sqlResult1.getHql());
        ...
        HqlQuery sqlResult2 = QueryUtils.getConditionHqlQuery(test2, null);
        Assertions.assertEquals(" .B like :B_0", sqlResult2.getHql());
        ...
        HqlQuery sqlResult3 = QueryUtils.getConditionHqlQuery(test3, null);
        Assertions.assertEquals(" .C >= :C_0", sqlResult3.getHql());
        ...
        HqlQuery sqlResult4 = QueryUtils.getConditionHqlQuery(test4, null);
        Assertions.assertEquals("( .A = :A_0 OR  .B like :B_1 OR  .C >= :C_2)", sqlResult4.getHql());
        ...
        HqlQuery sqlResult5 = QueryUtils.getConditionHqlQuery(test5, null);
        Assertions.assertEquals(" .B < :B_0", sqlResult5.getHql());
        ...
        HqlQuery sqlResult6 = QueryUtils.getConditionHqlQuery(test6, null);
        Assertions.assertEquals(" .D <= :D_0", sqlResult6.getHql());
        ...
        HqlQuery sqlResult7 = QueryUtils.getConditionHqlQuery(test7, null);
        Assertions.assertEquals("(( .A = :A_0 OR  .B like :B_1 OR  .C >= :C_2) AND  .B < :B_3 AND  .D <= :D_4)", sqlResult7.getHql());
