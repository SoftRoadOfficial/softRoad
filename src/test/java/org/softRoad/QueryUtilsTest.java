...
public class QueryUtilsTest {
    ...
    public void getSqlResultTest(){
        ...
        SimpleCondition test2 = new SimpleCondition("B", "temp", SimpleCondition.Operator.EQUAL);
        SearchConditionHqlQuery sqlResult2 = QueryUtils.getConditionHqlQuery(test2, null);
        Assertions.assertEquals("B=:B_0", sqlResult2.getSql());
        Assertions.assertEquals("temp", sqlResult2.getParams().get("B_0"));

        SimpleCondition test3 = new SimpleCondition("C", 0x55, SimpleCondition.Operator.EQUAL);
        ...
        Assertions.assertEquals("(A=:A_0 OR B=:B_1 OR C=:C_2)", sqlResult4.getSql());
        ...
        SimpleCondition test5 = new SimpleCondition("B", '8', SimpleCondition.Operator.EQUAL);
        ...
        SimpleCondition test6 = new SimpleCondition("D", 0b011, SimpleCondition.Operator.EQUAL);
        ...
        System.out.println(sqlResult7);
        Assertions.assertEquals("((A=:A_0 OR B=:B_1 OR C=:C_2) AND B=:B_3 AND D=:D_4)", sqlResult7.getSql());
